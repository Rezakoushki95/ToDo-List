	...
	func setNotifications() {
		...
		for index in 0..<toDoItems.count {
			if toDoItems[index].reminderSet {
				...
				toDoItems[index].notificationID = setCalendarNotification(title: toDoItem.name, subtitle: "Subtitle", body: toDoItem.notes, bagdeNumber: nil, sound: .default, date: toDoItem.date)
			}
		}
	}
